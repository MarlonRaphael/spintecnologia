  ...
  <div class="row my-4">
    ...
    <div class="col-xl-12">
      <div class="card mg-b-20">
        <div class="card-body">
          <h5 class="my-4">{{ __('Edit Order') }} #{{ $order->id }}</h5>
            ...
            <div class="container-fluid" id="listItems">
              ...
              <div class="form-row">
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="text" id="select-customer" value="{{ $order->customer->name }}" class="form-control"
                           readonly>
                ...
                <div class="col-3 col-sm-3 col-md-2 col-lg-2">
                  <div class="form-group">
                    ...
                    <input type="text" name="discount" id="inputDiscount"
                           ...
                           value="{{ old('discount', $order->discount) }}" placeholder="0,00">
                    @error('discount')
              ...
              @if($order->products->count())
                @foreach($order->products as $item)
                  <div class="form-row align-items-center item" id="item-{{ $loop->index }}">
                    <div class="col-9 col-sm-9 col-md-4 col-lg-4">
                      <div class="form-group">
                        <label for="selectItem-{{ $loop->index }}">Product</label>
                        <select name="items[{{ $loop->index }}][product_id]" id="selectItem-{{ $loop->index }}"
                    ...
                    <div class="col-3 col-sm-3 col-md-2 col-lg-2">
                      <div class="form-group">
                        <label for="inputQuantityItem-{{ $loop->index }}">Quantity</label>
                        <input type="number" name="items[{{ $loop->index }}][quantity]"
                               id="inputQuantityItem-{{ $loop->index }}" class="form-control"
                               value="{{ $item->pivot->quantity }}" required>
                      </div>
                    </div>
                    @if($loop->iteration > 1)
                      <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                        <button type="button" class="btn btn-secondary btn-remove mt-2"
                                data-value="{{ $loop->index }}">Delete</button>
                      </div>
                    @endif
                ...
                <div class="form-row align-items-center item" id="item-0">
                  ...
                  <div class="col-3 col-sm-3 col-md-2 col-lg-2">
                    <div class="form-group">
                      ...
                      <input type="number" name="items[0][quantity]" id="inputQuantityItem-0"
