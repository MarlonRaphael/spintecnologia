              ...
              <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="name" id="input-name"
                         ...
                         value="{{ old('name', $product->name) }}" placeholder="Product Name" required autofocus>
                  @error('name')
              ...
              <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="description" id="input-description"
                         ...
                         value="{{ old('description', $product->description) }}" placeholder="Description" required>
                  @error('description')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="barcode" id="input-barcode"
                         ...
                         value="{{ old('barcode', $product->barcode) }}" placeholder="Barcode" min="10" max="15" maxlength="15" required>
                  @error('barcode')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
